  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-[50%]'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500ox] px-3 py-2' type="text" placeholder='Type here' required />
      </div>
      <div className='w-[50%]'>
        <p className='mb-2'>Product description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500ox] px-3 py-2' type="text" placeholder='Write content here' required />
      </div>
